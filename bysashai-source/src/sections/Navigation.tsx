...
export default function Navigation() {
  ...
  if (!nav.brandName && nav.links.length === 0) {
    return null;
  }
        ...
        <div style={{ display: 'flex', gap: '36px', alignItems: 'center' }}>
          ...
          <button
            ...
            style={{
              ...
              textTransform: 'uppercase',
              background: 'none',
              border: `1px solid ${baseTextColor}40`,
              borderRadius: '50px',
              padding: '6px 14px',
              cursor: 'pointer',
            ...
            onMouseEnter={(e) => {
              ...
              el.style.opacity = '1';
              el.style.borderColor = baseTextColor;
              el.style.backgroundColor = `${baseTextColor}15`;
            }}
            onMouseLeave={(e) => {
              const el = e.currentTarget;
              el.style.opacity = '0.85';
              el.style.borderColor = `${baseTextColor}40`;
